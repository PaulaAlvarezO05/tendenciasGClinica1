...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            name='medicamento',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='medicationInventory.medicationinventory', verbose_name='Medicamento'),
        ),
        migrations.AddField(
            model_name='prescription',
            name='paciente',
